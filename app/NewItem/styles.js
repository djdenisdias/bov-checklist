...
export const SafeAreaView = styled.SafeAreaView`
  ...
  padding-top: 30px;
`
export const NewItemWrapper = styled.View`
	width: 100%;
  height: 100%;
`
export const NewItemHeader = styled.View`
  color: #ffffff;
  width: 100%;
  height: 65px;
  text-align: center;
...
export const Title = styled.Text `
  ...
  line-height: 65px;
`
export const NewItemBody = styled.KeyboardAvoidingView`
  flex: 1;
`
export const NewItemScrollBody = styled.ScrollView`
